...
app.config ( function ( $routeProvider) {
  ...
  app.controller('screenerCtrl', ['$scope' , '$http' , function($scope, $http , $log) {
...
app.controller("login2Ctrl",  function ($scope , $http , $location, $window , $rootScope , AuthService , DataService ) {
